            ...
            <>
              ...
              <div className="grid grid-cols-2 gap-2 sm:gap-3">
                {[
                  ...
                  <div key={i} className="p-2.5 sm:p-3 rounded-lg bg-muted/50 border border-border flex flex-col gap-0 min-h-[5.5rem]">
                    <div className="flex items-center gap-1.5 sm:gap-2 mb-1">
                      {feature.icon}
                      <span className="text-xs sm:text-sm font-medium text-foreground leading-tight whitespace-nowrap">{feature.title}</span>
                    </div>
                    <p className="text-[11px] sm:text-xs text-muted-foreground leading-relaxed flex-1">{feature.desc}</p>
                  </div>
                ))}
              </div>
